...
//            return "redirect:/";
    ...
    public String itemFormPost(@Valid ItemDTO itemDTO, BindingResult bindingResult, List<MultipartFile> multipartFiles, Model model) {
        //들어오는 값 확인
        ...
        try {
            ...
            log.info("파일 등록 간 문제 발생.");
            model.addAttribute("msg", "파일등록을 잘 해주세요");
            return "/item/itemForm";    //다시 이전 페이지
        }
